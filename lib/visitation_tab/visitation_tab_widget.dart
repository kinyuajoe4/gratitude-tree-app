...
import 'visitation_tab_model.dart';
...
class _VisitationTabWidgetState extends State<VisitationTabWidget> {
  late VisitationTabModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisitationTabModel());
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  Expanded(
                    child: wrapWithModel(
                      model: _model.monitorTempModel,
                      updateCallback: () => setState(() {}),
                      child: MonitorTempWidget(),
                    ),
                  ),
                ],
              ),
