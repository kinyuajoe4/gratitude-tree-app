...
Future<double> carbonFootprint(
  double carboncalculator,
  ...
  double carbonFootprinted = 0.0;

// Calculate carbon sequestration per tree based on diameter and age
  if (carbonreduction >= 0 && carboncalculator >= 0) {
    carbonFootprinted = (carboncalculator - carbonreduction);
  }
  return carbonFootprinted;
}
