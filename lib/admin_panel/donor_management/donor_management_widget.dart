...
import 'donor_management_model.dart';
...
class _DonorManagementWidgetState extends State<DonorManagementWidget> {
  late DonorManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DonorManagementModel());
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'ministryofhealth@domainname.com',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium,
                                                ),
