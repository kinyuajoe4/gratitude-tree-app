...
import 'activities_copy_model.dart';
export 'activities_copy_model.dart';

class ActivitiesCopyWidget extends StatefulWidget {
  const ActivitiesCopyWidget({super.key});

  @override
  State<ActivitiesCopyWidget> createState() => _ActivitiesCopyWidgetState();
}

class _ActivitiesCopyWidgetState extends State<ActivitiesCopyWidget>
    with TickerProviderStateMixin {
  late ActivitiesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivitiesCopyModel());
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 6.0, 48.0, 0.0),
                                                child: Text(
                                                  'Challenge your friends by planting the most steps on Saturday and Sunday!',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
