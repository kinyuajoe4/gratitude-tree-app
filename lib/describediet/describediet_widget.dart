...
import 'describediet_model.dart';
export 'describediet_model.dart';

class DescribedietWidget extends StatefulWidget {
  const DescribedietWidget({
    super.key,
    this.footprintfrompreviouspae,
  });

  final double? footprintfrompreviouspae;

  @override
  State<DescribedietWidget> createState() => _DescribedietWidgetState();
}

class _DescribedietWidgetState extends State<DescribedietWidget>
    with TickerProviderStateMixin {
  late DescribedietModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DescribedietModel());
                            ...
                            SelectionArea(
                              ...
                              valueOrDefault<String>(
                                (_model.radioButtonValue1 == null ||
                                    ...
                                    ? widget.footprintfrompreviouspae
                                        ?.toString()
