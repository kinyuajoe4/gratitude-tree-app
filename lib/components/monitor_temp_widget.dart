...
import '/components/maps_bottom_sheet_copy_copy_widget.dart';
...
import 'monitor_temp_model.dart';
export 'monitor_temp_model.dart';
...
class _MonitorTempWidgetState extends State<MonitorTempWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MonitorTempModel());
        ...
        children: [
          Align(
            ...
            child: FlutterFlowButtonTabBar(
              ...
              buttonMargin: EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 0.0, 0.0),
              ...
              children: [
                StreamBuilder<List<MytreesRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<MytreesRecord> listViewMytreesRecordList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, listViewIndex) {
                        final listViewMytreesRecord =
                            listViewMytreesRecordList[listViewIndex];
                        return Padding(
                          ...
                          child: StreamBuilder<MytreesRecord>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final cardProduct40MytreesRecord = snapshot.data!;
                              return InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    'treedetailsfromvisitatationtab',
                                    queryParameters: {
                                      'treedetails': serializeParam(
                                        cardProduct40MytreesRecord.reference,
                                ...
                                children: [
                                  ...
                                  Switch.adaptive(
                                    ...
                                    onChanged: (newValue) async {
                                      ...
                                      if (newValue!) {
                                        _model.days =
                                            await actions.timeDifferenceInDays(
                                          _model.datePicked,
                                        );
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Reminder set in ${_model.days?.toString()}days.',
                                              style: TextStyle(
                                                color: Color(0xFF10FF00),
                                              ),
                                            ),
