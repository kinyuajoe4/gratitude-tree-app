...
import 'treedetailsfromvisitatationtab_model.dart';
export 'treedetailsfromvisitatationtab_model.dart';
...
class _TreedetailsfromvisitatationtabWidgetState
    extends State<TreedetailsfromvisitatationtabWidget>
    with TickerProviderStateMixin {
  late TreedetailsfromvisitatationtabModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TreedetailsfromvisitatationtabModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MytreesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final treedetailsfromvisitatationtabMytreesRecord = snapshot.data!;
        return Title(
            title: 'treedetailsfromvisitatationtab',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              treedetailsfromvisitatationtabMytreesRecord
                                  .treeName,
                        ...
                        children: [
                          ...
                          StreamBuilder<MytreesRecord>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final containerMytreesRecord = snapshot.data!;
                              return Material(
                                ...
                                child: Container(
                                  width:
                                      MediaQuery.sizeOf(context).width * 0.915,
                                  height: 475.0,
