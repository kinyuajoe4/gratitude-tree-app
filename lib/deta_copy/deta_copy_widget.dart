...
class _DetaCopyWidgetState extends State<DetaCopyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetaCopyModel());
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.treeNameController,
                      focusNode: _model.treeNameFocusNode,
                      autofocus: true,
                      obscureText: false,
                      ...
                      validator: _model.treeNameControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await TreeLibraryRecord.collection
                          .doc()
                          .set(createTreeLibraryRecordData(
                            treeName: _model.treeNameController.text,
                            treeImage: _model.imageLinkController.text,
                            description: _model.descriptionController.text,
                          ));
                      setState(() {
                        _model.treeNameController?.clear();
