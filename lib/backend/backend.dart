...
/// Functions to query TreeLibraryRecords (as a Stream and as a Future).
Future<int> queryTreeLibraryRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TreeLibraryRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TreeLibraryRecord>> queryTreeLibraryRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TreeLibraryRecord.collection,
      TreeLibraryRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TreeLibraryRecord>> queryTreeLibraryRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query FielddetailsRecords (as a Stream and as a Future).
Future<int> queryFielddetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FielddetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FielddetailsRecord>> queryFielddetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FielddetailsRecord.collection,
      FielddetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FielddetailsRecord>> queryFielddetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query MytreesRecords (as a Stream and as a Future).
Future<int> queryMytreesRecordCount({
...
Stream<List<MytreesRecord>> queryMytreesRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<MytreesRecord>> queryMytreesRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
