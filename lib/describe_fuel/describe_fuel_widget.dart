...
import 'describe_fuel_model.dart';
export 'describe_fuel_model.dart';

class DescribeFuelWidget extends StatefulWidget {
  const DescribeFuelWidget({
    super.key,
  ...
  @override
  State<DescribeFuelWidget> createState() => _DescribeFuelWidgetState();
}

class _DescribeFuelWidgetState extends State<DescribeFuelWidget>
    with TickerProviderStateMixin {
  late DescribeFuelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DescribeFuelModel());
